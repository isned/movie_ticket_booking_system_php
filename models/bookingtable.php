...
class BookingTable {
    ...
    public function __construct($bookingID="", $movieID="", $bookingTheatre="", $bookingType="", $bookingDate="", $bookingTime="", $bookingFName="", $bookingLName="", $bookingPNumber="", $bookingEmail="", $amount="") {
