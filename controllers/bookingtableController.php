<?php
include_once('../models/bookingtable.php') ;
...
function insert_add(BookingTable $c){
 ...
 $aryy =array($c->getMovieID(),$c->getBookingTheatre(),$c->getBookingType(),$c->getBookingDate(),$c->getBookingTime(),$c->getBookingFName(),$c->getBookingLName(),$c->getBookingPNumber(),$c->getBookingEmail(),$c->getAmount()) ;
 //var_dump($aryy);
