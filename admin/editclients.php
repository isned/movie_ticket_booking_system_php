            ...
            <div class="admin-section-column">
                ...
                <div class="admin-section-panel admin-section-panel2">
                    ...
                    <div class="booking-form-container">
                        <form method="POST" action="../view/modification_clients.php" enctype="multipart/form-data">
                            
                         Client_ID <input type="text" name="id" value="<?php echo $res['id'] ?>" Required readonly>
                       ...
                       Password <input type="text" name="password" value="<?php echo $res['password'] ?>" Required>
                       Phone <input type="text" name="phone" value="<?php echo $res['phone'] ?>" Required>
                       Email <input type="text" name="email" value="<?php echo $res['email'] ?>" Required> 
