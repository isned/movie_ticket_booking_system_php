...
session_start();
require_once('bookingtableController.php');
...
if (isset($_POST['submit'])) {
  ...
  $bookingtable=new bookingtable($movieid, $theatre, $type, $date, $time, $amount,$uname);
...
<body>
    <center>
            ...
            <table border="1" style="text-align: center;">
              ...
              <!--     <tr>
                ...
                <!--    <tr>
                        ...
                        <td><?php echo $_POST[''] . " " . $_POST['lName']; ?></td>
                    </tr>
                    <tr>-->
                        <td>3</td>
        ...
        <button type="submit" class="btn btn-warning mt-3" id='send-button'>Payez <span class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true"></span></button>
                        <script>
let tnd_eth_fx;
let price_tnd = <?php echo $ta; ?>;
let account;
